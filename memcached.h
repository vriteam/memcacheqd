...
#ifdef ENABLE_UPDATE
    void **qptr;      /* location in queue*/
#endif
    rel_time_t      time;       /* least recent access */
    rel_time_t      exptime;    /* expire time */
    int             nbytes;     /* size of data */
    unsigned short  refcount;
    uint32_t        qid;       /* the id of queue */
...
item *item_queue_get(size_t);
item *item_queue_look(size_t);
...
/**
 * add queue info functiong
 */
void memcache_queue_stat_reset(void);
void memcache_queue_stats(ADD_STAT, void*);
void memcache_queues_stats(ADD_STAT, void*);
